# Итоговый проект по автоматизации тестирования функционала страницы сайта "Ростелеком"

При проектировании автоматизированных тестов быд применен паттерн PageObject.

При тестировании сайта были написаны:
- тест-кейсы (https://drive.google.com/drive/folders/1woaFgwNSJgWNLmBU_GdwTm9gjh5gNprW?usp=sharing);
- баг-репорты;
...
Окружение: Google Chrome Версия 122.0.6261.129, Windows 11 Home (64 бит)
